...
if Q1 == "Left":
    Q2=input("The tunnel on the left takes you down a long flight of stairs. As you descend into the darkness you can hear the faint sound of running water. Eventually you come across a large underground lake, the water is so dark that anything could be lurking just below the surface. Do you Swim for it, or Wait and see if a boat appears?\n")
    if Q2 == "Wait":
        Q3= input("Your patinece has paid off and across the water you can see a ferryman on a small boat approaching. he allows you to board and takes you across the murky depths. He leaves you at the other side with two doors in front of you and the vast expanse of water behind you. Which door will you choose, a faded, old, Red door, or a Blue door?\n")
        if Q3== "Red":
